...
def _patch_mixed_dispatcher(monkeypatch, module, method_name: str, orig_schedule, rev_schedule):
    call_log = []
...
def _patch_machine_dispatcher(monkeypatch, module, method_name: str, orig_schedule, rev_schedule):
...
def test_mixed_methods_choose_reversed_when_better(monkeypatch, method_name, dispatcher_method):
    ...
    assert call_log[0][1]["get_file_path_for_subroutine"] is ctrl.get_file_path_for_subroutine
...
def test_mixed_methods_keep_original_on_tie(monkeypatch, method_name, dispatcher_method):
    import hybridflowshop.controller.hfs_cp_lns as module
...
def test_dm_methods_choose_reversed_when_better(monkeypatch, method_name, dispatcher_method):
    import hybridflowshop.controller.hfs_cp_lns as module
