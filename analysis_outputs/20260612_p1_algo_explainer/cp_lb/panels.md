...
- Restored full-schedule makespan = 426; optimality gap to LB = 7.
...
- `step_04_hint_based_dispatch_full.svg`: Hint-based dispatch: retained-CP anchors restore a full feasible 4-stage schedule, makespan = 426. Lower bound LB = 419 vs restored makespan 426 -> optimality gap = 7. (Analytic SHD LB input was 384; retained-CP LB refines it to 419.)
