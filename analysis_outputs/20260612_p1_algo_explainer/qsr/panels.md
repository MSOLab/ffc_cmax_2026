...
- repair before->after      : 426 -> 420

## Panels

- `step_01_quantize_original.svg`: QUANTIZE (left): original full-resolution schedule with real p_ij. makespan=426 (real-resolution axis, auto-fit; x ticks step 100). Caption: 'x눈금 100단위 (real time)'.
...
- `step_07_repair_before.svg`: REPAIR (before): best restore (machine_sequence) installed as incumbent. makespan=426 (real-resolution axis, auto-fit; x ticks step 100).
