...
- Restored full-schedule makespan = 966; optimality gap to LB = 7.
...
- `step_04_hint_based_dispatch_full.svg`: Hint-based dispatch: retained-CP anchors restore a full feasible 4-stage schedule, makespan = 966. Lower bound LB = 959 vs restored makespan 966 -> optimality gap = 7. (Analytic SHD LB input was 959; retained-CP LB refines it to 959.)
